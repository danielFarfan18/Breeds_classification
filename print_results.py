...
from save_data import save_model_results
...
def print_results(results_dic, results_stats_dic, model, 
    ...
    save_model_results('model_results.csv', model, results_stats_dic['n_images'], results_stats_dic['n_dogs_img'], results_stats_dic['n_notdogs_img'], results_stats_dic)
